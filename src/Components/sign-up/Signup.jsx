      ...
      <div className="bg-white h-full">
        ...
        <div className="flex pt-10 justify-center items-center">
          ...
          <form action="" onSubmit={handleSubmit(onSubmitForm)}>
            <div >
              <div className="  bg-white px-10 py-30 rounded-lg   ">
        ...
        : "text-xs flex bg-white border border-black py-5 px-2 text-primary placeholder:text-slate-500 flex-grow focus:border-purple-500 focus:border-2"
                  ...
                  <div className="py-5">
                    <button
                      ...
                      disabled={!isValid}
                    />
                    <p className="text-center pr-20 flex justify-center pt-4 ">
                      Already a member? |{" "}
                  ...
                  <div className="flex justify-center items-center w-full bg-green-700 mb-8">
                    <button className="text-white bg-green-700 p-2 rounded " type="submit ">
                      Submit
                    </button>
                  </div>
                </div>
              </div>
              <div className="w-1/2  p-0 m-0 flex-wrap lg:block hidden ">
                <div className="h-auto ">
                  {/* <Image
                  src={Bg}
                  alt="background"
                  className="w-[540px] mt-20 -z-50 "
                /> */}
                </div>
              </div>
            </div>
