            ...
            <div className="p-6 space-y-6">
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-lg font-semibold">{ticketData.full_name}</p>
                </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            >
              ...
              <option value="3 Month">Three Month Package -> Rs.3240</option>
          ...
          <div>
            ...
            <div className="flex items-center space-x-2">
              ...
              {image && <img className='ml-4' width="60" height="60" src={URL.createObjectURL(image)} />}
